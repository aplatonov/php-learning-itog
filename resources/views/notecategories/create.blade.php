...
@section('content_header')
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"> Добавление типа сообщения</li>
    </ol>
@stop
        ...
        <div class="col-xs-12">
            <div class="box box-success">
                <div class="box-header with-border">
                    <h3 class="box-title">Добавление типа сообщения</h3>
                </div><!-- /.box-header -->
                <form role="form" method="POST" action="{{route('notecategories.store')}}">
                    {{ csrf_field() }}
                    <div class="box-body">
                        <div class="row">
                            <!-- left column -->
