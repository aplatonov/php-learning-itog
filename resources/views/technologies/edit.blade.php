...
@section('content_header')
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"> Редактирование технологии</li>
    </ol>
@stop
         ...
         <div class="col-xs-12">
            <div class="box box-success">
                <div class="box-header with-border">
                    <h3 class="box-title">Редактирование технологии</h3>
                </div><!-- /.box-header -->
                <form role="form" method="POST" action="{{ route('technologies.update', $technology->id) }}">
                                ...
                                <div class="box">
                                    <div class="box-body">
                                        ...
                                        <div class="form-group col-xs-12">
                                            <div class="checkbox">
                                                <label for="active">
                                                    <input type="checkbox" id="active" name="active" {{ $technology->active ? 'checked' : ''}} value="1">
                                                    Активно
                                                </label>
